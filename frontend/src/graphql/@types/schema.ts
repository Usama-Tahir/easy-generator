...
export type SignUpMutation = { __typename: 'Mutation', signUp: { __typename: 'AuthPayload', accessToken: string, user: { __typename: 'User', isActive: boolean, _id: string, email: string } } };
